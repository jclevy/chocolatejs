...
(function() {
  var $, Dom, Events, Query, Style, core, core_array, core_hasOwn, core_isArraylike, core_object, core_toArray, core_version, i, k, o, previous$, v, _base, _base1, _base2, _i, _len, _ref;
  ...
  $.map = function(elems, callback, arg) {
    var i, length, ret, value, _mapone;
    ret = [];
    i = 0;
    value = null;
    length = elems.length;
  ...
  Events = (function($) {
    ...
    _unsubscribe = function(element, event, callback, selector) {
      var element_id, handler, _i, _len, _ref, _results;
      event = _environmentEvent(event);
      element_id = _getElementId(element);
      _ref = _findHandlers(element_id, event, callback, selector);
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        handler = _ref[_i];
        delete Events_handlers[element_id][handler.index];
        _results.push($.event.remove(element, handler.event, handler.proxy));
      }
      return _results;
    };
    ...
    return {
      ...
      triggerHandler: function(event, args) {
        ...
        this.each(function(i, element) {
          var e, element_id, _ref;
          e = _createProxy($.type(event) === 'string' ? $.Event(event) : event);
          e._args = args;
          e.target = element;
          element_id = _getElementId(element);
          return $.each(_findHandlers(element_id, (_ref = event.type) != null ? _ref : event), function(i, handler) {
  ...
  Dom = (function($) {
    ...
    _stripScripts = function(text, callback) {
      var code, html, item, script, scripts, src, _i, _len;
      scripts = [];
    ...
    return {
        ...
        this.each(function() {
          ...
          if (this.parentNode) {
            if (type === "string") {
              ...
              for (_i = 0, _len = value.length; _i < _len; _i++) {
                v = value[_i];
                _results.push($(this).replaceWith(v));
              }
              return _results;
            } else {
      ...
      offset: function() {
        var bounding, _ref, _ref1;
        if (this.length === 0) {
          return {};
        }
        bounding = this[0].getBoundingClientRect();
        return {
          left: bounding.left + ((_ref = window.pageXOffset) != null ? _ref : document.documentElement.scrollLeft),
          top: bounding.top + ((_ref1 = window.pageYOffset) != null ? _ref1 : document.documentElement.scrollTop),
  ...
  core = {
    length: 0,
    init: function(a) {
      return core_array.push.apply(this, a && a.nodeType ? [a] : ("" + a === a ? core_toArray(document.querySelectorAll(a)) : ((function() {
        if (/^f/.test(typeof a)) {
  ...
  if (document.querySelectorAll == null) {
    document.querySelectorAll = (function() {
      ...
      return function(selectors) {
        var all, elements, i, j, _j, _k, _ref1, _ref2;
        all = document.all;
        elements = [];
        selectors = selectors.replace(/\[for\b/gi, '[htmlFor').split(',');
        for (i = _j = 0, _ref1 = selectors.length; _j < _ref1; i = _j += 1) {
          style.addRule(selectors[i], 'k:v', 0);
          for (j = _k = 0, _ref2 = all.length; _k < _ref2; j = _k += 1) {
  ...
  if ((_base1 = String.prototype).trim == null) {
    _base1.trim = function() {
  ...
  if ((_base2 = Array.prototype).indexOf == null) {
    _base2.indexOf = function(elem) {
      var _j, _k, _ref1, _ref2;
      if (this.charAt != null) {
        for (i = _j = 0, _ref1 = this.length; _j < _ref1; i = _j += 1) {
          if (this.charAt(i) === elem) {
            return i;
          }
        }
      } else {
        for (i = _k = 0, _ref2 = this.length; _k < _ref2; i = _k += 1) {
          if (this[i] === elem) {
            return i;
          }
        }
