  ...
  Newnotes = (function() {
    ...
    _Class.HtmlPanel = (function() {
      ...
      _Class.prototype.logoff = function() {
        var _ref,
          _this = this;
        if (((_ref = this.url) != null ? _ref.forget_keys : void 0) != null) {
          return new Request({
    ...
    _Class.manifest = function(__) {
      var filename, fs, line, stats, time_stamps, time_stamps_list, to_cache, to_cache_list, _i, _j, _len, _len1, _ref;
      Chocokup = require('./chocokup');
