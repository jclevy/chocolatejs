  ...
  Newnotes = (function() {
        ...
        for (name in _ref2) {
          ...
          for (key in _ref3) {
            ...
            for (_j = 0, _len1 = _ref4.length; _j < _len1; _j++) {
              item = _ref4[_j];
              ((_base = data.by[name])[key] != null ? _base[key] : _base[key] = []).push(item.uuid);
            }
          }
        }
                ...
                if ((list = parent != null ? parent.subs : void 0) != null) {
                  for (_i = 0, _len = list.length; _i < _len; _i++) {
                    ...
                    if (item_index < index) {
                      ...
                      ((_base = _this.newnotes.data.by[name])[value] != null ? _base[value] : _base[value] = []).push(parent);
                      index = item_index;
                      modified = true;
                    }
                  }
    ...
    _Class.prototype.add = function(title, after, step) {
      ...
      for (name in _ref1) {
        ...
        ((_base = this.data.by[name])[_name = dimension.value] != null ? _base[_name] : _base[_name] = []).push(note);
      }
      return note;
    };
    ...
    _Class.prototype.modify = function(note, option, value) {
      ...
      if ((option != null) && (value != null)) {
        if (note.dimensions[option] !== value) {
          ...
          ((_base = this.data.by[option])[_name = note.dimensions[option]] != null ? _base[_name] : _base[_name] = []).push(note);
          note.date.modified = new Date();
        }
      }
    };
              ...
              iterate = function(uuid, note) {
                ...
                if (data.by.id[uuid] == null) {
                  ...
                  for (name in _ref7) {
                    ...
                    key = _ref7[name];
                    ((_base = data.by[name])[key] != null ? _base[key] : _base[key] = []).push(uuid);
                  }
                  _ref8 = note.subs;
                  _results = [];
                  for (i in _ref8) {
              ...
              kup = function() {
                ...
                impress = (function() {
                  ...
                  impress.prototype.set = function(so, what, how, value) {
                    ...
                    _so = (_base = this.defaults)[so] != null ? _base[so] : _base[so] = {};
                    if (value != null) {
                      return _so[what] = {
                        how: how,
                        value: value
