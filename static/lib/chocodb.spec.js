...
(function() {
  ...
  chocoDB = require('chocolate/general/chocodb');

  describe('chocoDB', function() {
    var db, times;
    db = void 0;
    times = [];
    it('does not already exist ', function() {
      ...
      ready = false;
      exists = void 0;
      chocoDB.exists(function(e) {
        ready = true;
        return exists = e;
      });
      waitsFor((function() {
        return ready;
      }), 'ChocoDB to tell if it already exists', 1000);
    ...
    it('should flush again the modifications to localStorage or to disk', function() {
      ...
      waitsFor((function() {
        return flushed;
      }), 'ChocoDB to be flushed again', 1000);
      return runs(function() {
        return expect(flushed).toBe(true);
      });
    });
    ...
    it('should compact at some point in the past', function() {
      ...
      waitsFor((function() {
        return done;
      }), 'ChocoDB to be compacted in the past', 2000);
      return runs(function() {
        ...
        if (typeof window === "undefined" || window === null) {
          ...
          lines = localStorage.getItem('ChocoDB').split('\n');
    ...
    it('should compact now', function() {
      ...
      waitsFor((function() {
        return done;
      }), 'ChocoDB to be compacted now', 2000);
      return runs(function() {
        var count, ref, ref1;
        count = ((ref = db()) != null ? ref.result.debug_log.length : void 0) - 1;
        return expect((ref1 = db()) != null ? ref1.result.debug_log[count] : void 0).toBe('done 4 times');
    ...
    it('should not exist anymore', function() {
      ...
      waitsFor((function() {
        return done;
      }), 'ChocoDB to tell if it still exists', 1000);
      return runs(function() {
        return expect(exists).toBe(false);
      });
    });
    ...
    it('should delete the default DB again', function() {
      ...
      waitsFor((function() {
        return done;
      }), 'ChocoDB to be deleted again', 1000);
      return runs(function() {
        var ref;
        return expect((ref = db()) != null ? ref.constructor : void 0).toBe({}.constructor);
      });
    ...
    return xit('should not exist anymore again', function() {
      ...
      waitsFor((function() {
        return done;
      }), 'ChocoDB to tell if it still exists again', 1000);
      return runs(function() {
        return expect(exists).toBe(false);
      });
    });
