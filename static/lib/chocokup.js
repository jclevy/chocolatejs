...
(function() {
  var Chocokup, Coffeekup, _, _module, _ref,
    __slice = [].slice,
  ...
  Chocokup = (function() {
    ...
    Chocokup.helpers = (function() {
      ...
      _Class.prototype.verify = function() {
    ...
    Chocokup.prototype.render = function(options) {
      var bin, data, format, helper_ext, helpers, k, locals, v, __, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      ...
      format = (_ref9 = options != null ? options.format : void 0) != null ? _ref9 : false;
      data = {
        params: this.params,
        format: format,
        hardcode: helpers,
    ...
    Document.prototype.head_template = function() {
      ...
      return html({
        ...
        head(function() {
          ...
          return style("" + Chocokup.Css[(_ref1 = (_ref2 = this.params) != null ? _ref2.theme : void 0) != null ? _ref1 : "reset"] + "\n" + Chocokup.Css.core);
        });
        return text("" + (this.__.body()));
      });
    };
  ...
  Chocokup.App = (function(_super) {
    ...
    App.prototype.body_template = function() {
      var _ref1;
      if ((_ref1 = this.params) != null ? _ref1.with_coffee : void 0) {
        script({
  ...
  Chocokup.Css.Animation = (function() {
    ...
    Animation.create = function(anims, css_class) {
      var anim, css, delay, i, prefix, result, time, what, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref1, _ref2, _ref3, _ref4;
      result = '';
      if (css_class == null) {
        css_class = {};
      }
      ...
      for (i = _i = 0, _len = anims.length; _i < _len; i = ++_i) {
        ...
        switch (anim.type) {
          case 'typing':
            time = 0.15;
            css.push("." + ((_ref1 = anim.css) != null ? _ref1 : 'typing') + ".text-" + i + "." + css_class.trigger + " span {");
