...
(function() {
  var Chocodown, Doccolate, Highlight, docco_template, ext, generate, generate_html, get_language, highlight, highlight_end, highlight_start, l, languages, options, parse, path, template, _module;
  ...
  highlight = function(source, sections) {
    var code, fragments, i, language, result, section, _i, _len, _results;
    ...
    for (i = _i = 0, _len = sections.length; _i < _len; i = ++_i) {
      ...
      _results.push(section.docs_html = new Chocodown.converter().makeHtml(section.docs_text));
    }
    return _results;
  };
