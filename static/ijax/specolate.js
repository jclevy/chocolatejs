...
(function() {
  var Specolate, available, finished, log, _exports,
    __hasProp = {}.hasOwnProperty;

  _exports = typeof window !== "undefined" && window !== null ? window.Specolate = {} : module.exports;
  ...
  Specolate = (function() {
    ...
    Specolate.get_extension = function(path) {
      if ((path = path.substr(1 + path.indexOf('/'))).indexOf('.') === -1) {
        return '';
      } else {
    ...
    Specolate.get_spec_filename = function(path) {
      ...
      if ((ext = Specolate.get_extension(path)) !== '') {
    ...
    Specolate.report = function(module_filename, options, callback) {
      var context, event, host, ijax_options, k, reporter, result, specolate_filename, v, vm;
      if (!finished) {
        return '';
      }
