...
(function() {
  ...
  Newnotes = (function() {
    _Class.kup = function() {
      var css_class, id, newnotes_filter, newnotes_filter_list, newnotes_list, newnotes_log_buttons, newnotes_note_action, newnotes_note_attributes, newnotes_note_history, newnotes_note_input, newnotes_note_memory, newnotes_note_message, newnotes_search, _base, _ref;
      id = Newnotes.panels.length;
      if ((_base = this.params).taste == null) {
        _base.taste = '';
      }
      ...
      css_class = (_ref = this.params.box_css_class) != null ? _ref : '';
      if (css_class !== '') {
        css_class = '.' + css_class;
      }
      ...
      newnotes_search = function() {
        var add_selector, name, _ref1, _results,
          _this = this;
    ...
    _Class.HtmlPanel = (function() {
      ...
      _Class.prototype["export"] = function() {
        var data, item, key, name, note, uuid, _base, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
          _this = this;
        ...
        for (name in _ref2) {
          ...
          for (key in _ref3) {
            ...
            for (_j = 0, _len1 = _ref4.length; _j < _len1; _j++) {
              item = _ref4[_j];
              ((_base = data.by[name])[key] != null ? (_base = data.by[name])[key] : _base[key] = []).push(item.uuid);
            }
          }
        }
        if (((_ref5 = this.url) != null ? _ref5.save : void 0) != null) {
      ...
      _Class.prototype.list = function() {
        ...
        kup = function() {
          ...
          kup = function(selection) {
            var bullet, bullet_char, classes, compacted_title, index, is_compacted, item, priority, regexp, selected, state, str_content, str_title, _base, _i, _len, _name, _results;
            if (selection == null) {
            ...
            for (index = _i = 0, _len = selection.length; _i < _len; index = ++_i) {
              ...
              if ((_base = this.params.editor.tree_states)[_name = item.note.uuid] == null) {
                _base[_name] = {
                  node: false,
      ...
      _Class.prototype.on_tagging_change = function(note, do_self, dolist) {
        ...
        check = function(note, check_self) {
          var dimension, index, item, item_index, list, modified, name, parent, value, _base, _i, _len, _ref;
          modified = false;
              ...
              if ((list = parent != null ? parent.subs : void 0) != null) {
                for (_i = 0, _len = list.length; _i < _len; _i++) {
                  ...
                  if (item_index < index) {
                    ...
                    ((_base = _this.newnotes.data.by[name])[value] != null ? (_base = _this.newnotes.data.by[name])[value] : _base[value] = []).push(parent);
                    index = item_index;
                    modified = true;
                  }
                }
    ...
    _Class.prototype.add = function(title, after, step) {
      var dimension, index, item, list, name, note, parent, _base, _i, _len, _name, _ref, _ref1,
        _this = this;
      if (step == null) {
        step = -1;
      }
      ...
      for (name in _ref1) {
        ...
        ((_base = this.data.by[name])[_name = dimension.value] != null ? (_base = this.data.by[name])[_name = dimension.value] : _base[_name] = []).push(note);
      }
      return note;
    };
    ...
    _Class.prototype.modify = function(note, option, value) {
      ...
      if ((option != null) && (value != null)) {
        if (note.dimensions[option] !== value) {
          ...
          ((_base = this.data.by[option])[_name = note.dimensions[option]] != null ? (_base = this.data.by[option])[_name = note.dimensions[option]] : _base[_name] = []).push(note);
          note.date.modified = new Date();
        }
      }
    };
    ...
    _Class.prototype.select = function(parent, current) {
      var dimension, filtered, keep_note, list, name, note, regexp, selection, subs, _base, _base1, _i, _len, _ref, _ref1, _ref2, _ref3,
        _this = this;
      selection = [];
      selection.filtered = {
        exists: false,
      ...
      for (_i = 0, _len = list.length; _i < _len; _i++) {
        ...
        if (keep_note) {
          ...
          if ((_base = selection.filtered).first == null) {
    ...
    _Class.present = function(where, as, type, __) {
      var data, i, impress_html, impress_kup, iterate, key, kup, name, note, paper_html, paper_kup, result, returns, search, slides_html, slides_kup, str, title_compacted, uuid, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
          ...
          switch (as) {
            case 'json':
              ...
              iterate = function(uuid, note) {
                var sub, _base, _ref7, _ref8, _results;
                if (data.by.id[uuid] == null) {
                  data.by.id[uuid] = note["export"]();
                  _ref7 = note.dimensions;
                  for (name in _ref7) {
                    if (!__hasProp.call(_ref7, name)) continue;
                    key = _ref7[name];
                    ((_base = data.by[name])[key] != null ? (_base = data.by[name])[key] : _base[key] = []).push(uuid);
                  }
                  _ref8 = note.subs;
                  _results = [];
                  for (i in _ref8) {
              ...
              kup = function() {
                ...
                iterate = function(note, level, css) {
                  ...
                  if ((title = note.title)[0] === '$') {
                    _ref7 = note.subs;
                    for (uuid in _ref7) {
                      if (!__hasProp.call(_ref7, uuid)) continue;
                      sub = _ref7[uuid];
                      iterate(sub, level + 1);
                    }
                    return;
              ...
              kup = function() {
                ...
                impress = (function() {
                  ...
                  impress.prototype.step = function() {
                    var so, what, _ref7, _so, _what;
                    _ref7 = this.defaults;
                    for (so in _ref7) {
                      if (!__hasProp.call(_ref7, so)) continue;
                      _so = _ref7[so];
                      if (_so != null) {
                        switch (so) {
                          case 'move':
                  ...
                  impress.prototype.set = function(so, what, how, value) {
                    ...
                    _so = (_base = this.defaults)[so] != null ? (_base = this.defaults)[so] : _base[so] = {};
                    if (value != null) {
                      return _so[what] = {
                        how: how,
                        value: value
                ...
                iterate = function(note, level) {
                  var command, defaults, exit, line, lines, rx, ry, rz, s, si, so, splits, sub, title, tool, x, y, z, _l, _len3, _ref10, _ref11, _ref7, _ref8, _ref9, _results, _results1;
                  if ((title = note.title)[0] === '$') {
                    exit = true;
                  ...
                  switch (level) {
                    case 0:
                      ...
                      break;
                    case 1:
                      _ref9 = newnotes.impress.step(), x = _ref9.x, y = _ref9.y, z = _ref9.z, rx = _ref9.rx, ry = _ref9.ry, rz = _ref9.rz, s = _ref9.s, defaults = _ref9.defaults;
                      div({
            ...
            default:
              kup = function() {
                iterate = function(note, level) {
                  var sub, title, _ref7, _ref8, _ref9, _results, _results1;
                  if ((title = note.title)[0] === '$') {
                    _ref7 = note.subs;
                    for (uuid in _ref7) {
                      if (!__hasProp.call(_ref7, uuid)) continue;
