  ...
  Newnotes = (function() {
    ...
    _Class.Note = (function() {
      ...
      _Class.prototype["export"] = function() {
        ...
        note = new Newnotes.Note(this.title, this.parent, Object.clone(this.dimensions), this.uuid);
        if (note.parent != null) {
    ...
    _Class.present = function(where, as, __) {
      var data, i, impress_html, impress_kup, key, kup, name, note, paper_html, paper_kup, result, returns, search, slides_html, slides_kup, str, title_compacted, uuid, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;

      if (typeof window !== "undefined" && window !== null) {
        return '';
      }
      data = JSON.parse(require('fs').readFileSync(require.resolve('../' + __.datadir + '/newnotes_data.json')));
      if ((_ref = Chocodown.Chocokup) == null) {
        Chocodown.Chocokup = Chocokup;
      }
      if ((_ref1 = Chocodown.Highlight) == null) {
          ...
          switch (as) {
              ...
              kup = function() {
                ...
                iterate = function(note, level) {
                  return li(function() {
                    ...
                    if (((_ref8 = note.subs) != null ? _ref8.length : void 0) > 0) {
                      size = Math.max(16 - 2 * level, 12);
                      return ul({
                        style: "font-size:" + size + "pt"
                      }, function() {
                        var sub, _ref9, _results;
              ...
              kup = function() {
                ...
                impress = (function() {
                  ...
                  impress.prototype.step = function() {
                    var so, what, _ref8, _so, _what;

                    _ref8 = this.defaults;
                    for (so in _ref8) {
                      if (!__hasProp.call(_ref8, so)) continue;
                      _so = _ref8[so];
                      if (_so != null) {
                        switch (so) {
                          case 'move':
                  ...
                  impress.prototype.set = function(so, what, how, value) {
                    ...
                    _so = (_ref8 = (_base = this.defaults)[so]) != null ? _ref8 : _base[so] = {};
                    if (value != null) {
                      return _so[what] = {
                        how: how,
                        value: value
                ...
                iterate = function(note, level) {
                  var command, defaults, exit, line, lines, rx, ry, rz, s, si, so, splits, sub, title, tool, x, y, z, _l, _len3, _ref10, _ref11, _ref12, _ref8, _ref9, _results, _results1;
                  ...
                  if ((title = note.title)[0] === '$') {
                    ...
                    if (exit) {
                      _ref8 = note.subs;
                      for (uuid in _ref8) {
                        if (!__hasProp.call(_ref8, uuid)) continue;
                        sub = _ref8[uuid];
                        iterate(sub, level + 1);
                      }
                      return;
                  ...
                  switch (level) {
                    case 0:
                      ...
                      break;
                    case 1:
                      _ref10 = newnotes.impress.step(), x = _ref10.x, y = _ref10.y, z = _ref10.z, rx = _ref10.rx, ry = _ref10.ry, rz = _ref10.rz, s = _ref10.s, defaults = _ref10.defaults;
                      div({
                      ...
                      break;
                    case 2:
                      _ref12 = newnotes.impress.step(), x = _ref12.x, y = _ref12.y, z = _ref12.z, rx = _ref12.rx, ry = _ref12.ry, rz = _ref12.rz, s = _ref12.s, defaults = _ref12.defaults;
                      return div({
                        "class": "step " + (defaults.css['slide-style'].value.split('.').join(' ')),
                        'data-scale': s,
                        'data-x': x,
                        ...
                        return section(function() {
                          ...
                          if (note.subs.length > 0) {
                            ...
                            return ul({
                              ...
                              var _ref13, _results2;

                              _ref13 = note.subs;
                              _results2 = [];
                              for (uuid in _ref13) {
                                if (!__hasProp.call(_ref13, uuid)) continue;
                                sub = _ref13[uuid];
            ...
            default:
              kup = function() {
                ...
                iterate = function(note, level) {
                  var sub, _ref8, _ref9, _results, _results1;
