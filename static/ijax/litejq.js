...
(function() {
  ...
  $.Ajax = (function() {
    var Ajax_default, Ajax_jsonp_id, Ajax_mime_types, Ajax_settings, _jsonp, _parseResponse, _xhrError, _xhrForm, _xhrHeaders, _xhrStatus, _xhrSuccess, _xhrTimeout;
    Ajax_default = {
      type: "GET",
      mime: "json"
    };
    ...
    _parseResponse = function(xhr, settings) {
      ...
      if (response) {
        if (settings.dataType === Ajax_default.mime) {
          try {
  ...
  core = {
    length: 0,
    init: function(a) {
      return core_array.push.apply(this, a && a.nodeType ? [a] : ("" + a === a ? core_toArray(document.querySelectorAll(a)) : (/^f/.test(typeof a) ? [$(document).ready(a)] : $.type(a) === 'array' ? a : [])));
    },
    toArray: function() {
  ...
  if (window.JSON == null) {
    window.JSON = (function() {
      ...
      str = function(key, holder) {
        var gap, i, length, mind, partial, value;
        mind = gap;
        value = holder[key];
