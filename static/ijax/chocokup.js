  ...
  Chocokup = (function() {
    ...
    Chocokup.helpers = (function() {
      ...
      _Class.prototype.panel = function() {
        var attributes, content, content_, flush, id_class, new_id_class, orientation_keep, panel_index_keep, proportion_keep, _ref, _ref1, _ref2,
          _this = this;
      ...
      _Class.prototype.title = function() {
    ...
    Chocokup.prototype.render = function(options) {
      var body_html, content_html, format, head_html, helper_ext, helpers, k, locals, v, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
      ...
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        helper_ext = _ref3[_i];
        if (((_ref4 = this.params) != null ? _ref4[helper_ext] : void 0) != null) {
          _ref5 = this.params[helper_ext];
          for (k in _ref5) {
            v = _ref5[k];
            helpers[k] = v;
          }
      ...
      format = (_ref6 = options != null ? options.format : void 0) != null ? _ref6 : true;
