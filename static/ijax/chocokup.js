...
(function() {
  ...
  Chocokup = (function() {
    ...
    Chocokup.helpers = {
      ...
      panel: function() {
        var attributes, content, element, id_class, new_id_class, orientation_keep, panel_index_keep, proportion_keep, _ref, _ref1, _ref2, _ref3;
        ...
        if (proportion_keep !== 'none' && this.proportion === 'none') {
          element = div(id_class, function() {
            return div('space', attributes, content);
          });
        } else {
      ...
      header: function() {
        ...
        if ((attributes != null ? attributes.html5 : void 0) != null) {
          ...
          this.panel_infos[this.panel_infos.length - 1].hasHeader = true;
          id_class = 'header' + (id_class !== '' ? '.' : '') + id_class;
          if ((attributes != null ? attributes.by : void 0) != null) {
            id_class += '.by-' + attributes.by;
            this.panel_infos[this.panel_infos.length - 1].header_by = attributes.by;
          }
      ...
      footer: function() {
        ...
        if ((attributes != null ? attributes.html5 : void 0) != null) {
          ...
          this.panel_infos[this.panel_infos.length - 1].hasFooter = true;
          id_class = 'footer' + (id_class !== '' ? '.' : '') + id_class;
          if ((attributes != null ? attributes.by : void 0) != null) {
            id_class += '.by-' + attributes.by;
            this.panel_infos[this.panel_infos.length - 1].footer_by = attributes.by;
          }
          return panel(id_class, attributes, content);
        }
      },
      body: function() {
        var attributes, content, count, id_class, new_id_class, _ref;
        _ref = verify.apply(null, arguments), id_class = _ref.id_class, attributes = _ref.attributes, content = _ref.content;
        if (this.main_body_done != null) {
          new_id_class = 'body';
          if (this.panel_infos[this.panel_infos.length - 1].hasHeader !== true) {
            new_id_class += '.no-header';
          }
          if (this.panel_infos[this.panel_infos.length - 1].hasFooter !== true) {
            new_id_class += '.no-footer';
          }
          if (count = this.panel_infos[this.panel_infos.length - 1].header_by) {
            new_id_class += ".with-" + count + "-headers";
          }
          if (count = this.panel_infos[this.panel_infos.length - 1].footer_by) {
    ...
    Chocokup.prototype.render = function(options) {
      var body_html, content_html, format, head_html, locals, _ref, _ref1, _ref2;
      ...
      content_html = Coffeekup.render(this.content, {
        main_body_done: (_ref2 = this.params) != null ? _ref2.main_body_done : void 0,
        panel_index: 1,
        webcontrol_index: 0,
        proportion: 'none',
        orientation: 'none',
  ...
  Chocokup.Panel = (function(_super) {
    ...
    function Panel(params, content) {
      ...
      this.params.main_body_done = true;
    }
