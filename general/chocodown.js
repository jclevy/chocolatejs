...
if  (typeof CoffeeScript === "undefined" || CoffeeScript == null)
    if (typeof require === "function") CoffeeScript = require('coffee-script'); else require('coffee-script');
...
var _HashHTMLBlocks = function(text) {
	...
	// hard-coded:
	var block_tags_a = "style|p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|script|noscript|form|fieldset|iframe|math|ins|del"
	var block_tags_b = "style|p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|script|noscript|form|fieldset|iframe|math"
	...
	/*
		...
		/gm,function(){...}};
	*/
	text = text.replace(/^(<(style|p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|script|noscript|form|fieldset|iframe|math|ins|del)\b[^\r]*?\n<\/\2>[ \t]*(?=\n+))/gm,hashElement);
	...
	/*
		...
		/gm,function(){...}};
	*/
	text = text.replace(/^(<(style|p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|script|noscript|form|fieldset|iframe|math)\b[^\r]*?.*<\/\2>[ \t]*(?=\n+)\n)/gm,hashElement);
...
//
    ...
    // and ![foo][f] looks like an anchor.
    text = _DoImages(text);
...
var writeAnchorTag = function(wholeMatch,m1,m2,m3,m4,m5,m6,m7) {
    ...
    var target_str = url[0] !== '#' ? "target=\"_blank\" " : ""
	var result = "<a " + target_str + "href=\"" + url + "\"";
